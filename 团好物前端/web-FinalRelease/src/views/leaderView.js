...
export default () => {
    ...
    const back = () =>{
        if(!location.state.back) navigate('../');
        ...
        <div style={{flex: 1}}>
            ...
            <div style={{position:"absolute",top:100, left:20, height:60, width:60, zIndex:2 }}>
                <Image fit={"fill"} height={60} width={60} style={{borderRadius:8}}
                    src={'https://images.unsplash.com/photo-1567945716310-4745a6b7844b?ixid=' +
                        'MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=60'}/>
            </div>
