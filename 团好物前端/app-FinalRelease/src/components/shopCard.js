...
const ShopCard = (props) => {
    ...
    return (
            <Card bodyStyle={{ padding:4}} style={{borderRadius:12 ,margin:5}} onClick={()=>{navigate('/group_info', {state:{groupId:props.groupInfo.groupId ,back:'/home', backState:null}})}}>
        ...
        <Card bodyStyle={{ padding:4}} style={{borderRadius:12 ,margin:5}} onClick={()=>{navigate('/group_info', {state:{groupId:props.item.belongGroupId,back:'/home', backState:null}})}}>
